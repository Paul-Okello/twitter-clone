...
function Sidebar() {
  return (
    <div className='hidden sm:flex flex-col items-center xl:items-start xl:w-[340px] p-2 fixed h-full first-letter:'>
      ...
      <div className='text-[#d9d9d9] flex items-center justify-center mt-auto hover-animation xl:ml-auto xl:-mr-5 mb-3'>
        <img src='...' alt='' className='h-10 w-10 rounded-full xl:mr-2.5' />
        <div className='hidden xl:inline leading-5'>
          <h4 className='font-bold'>Lopoz</h4>
          <p className='text-[#6e767d]'>@Lopoz</p>
        </div>
